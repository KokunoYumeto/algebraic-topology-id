# Topologi Aljabar: Edisi Bahasa Indonesia — Roberts 1–30 dan Jembatan Homologi §1.1–1.10

Versi: `0.30.4`  
Tanggal: 25 Agustus 2026  
Status: **Roberts lengkap 30/30; Fomberg O012-FOM-001–004 lengkap; kursus komposit tetap parsial**
...
- O012-FOM-001–004 dari *Algebraic Topology* karya Yeheli Fomberg,
  berdasarkan kuliah Nir Lazarovich, `algebraic_topology.tex` baris 31–2846,
  Bagian 1.1–1.10, pada komit
  `563194fae879178b9a6871b249513bfc27968975`.

Kursor Fomberg berikutnya adalah baris 2847, awal Bagian 1.11 tentang pemetaan
derajat. Keempat komponen Fomberg **bukan** Kuliah Roberts 31–34. Kursus
komposit masih parsial karena Bagian 1.11–1.13, sisa lapisan pembuktian dan
penguasaan, laboratorium, serta capstone lintas-rute belum lengkap.

## Mulai membaca

1. `00_TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_004_READER.pdf`
   adalah pembaca A4 utama untuk pengunduhan. Font tersemat dan mempunyai peta
   ToUnicode; PDF belum bertag secara struktural.
2. `TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_004_READER.html`
...
Identitas byte, jumlah halaman, dan statistik backend final dicatat dalam
`release-manifest.json`, `SHA256SUMS`, dan receipt QA yang dihasilkan setelah
seluruh gate lokal lulus; dokumen ini sengaja tidak menduplikasi angka yang
dapat berubah sebelum penyegelan boundary.

## Sumber yang dapat dilanjutkan dan QA

- `TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_004_EDITABLE_SOURCE_BACKEND.zip`
...
- `TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_004_QA_PROVENANCE.zip`
...
Paket tidak memuat kredensial, cache, dump koordinasi, jalur lokal absolut,
data pribadi pengguna, atau salinan ganda pembaca.
