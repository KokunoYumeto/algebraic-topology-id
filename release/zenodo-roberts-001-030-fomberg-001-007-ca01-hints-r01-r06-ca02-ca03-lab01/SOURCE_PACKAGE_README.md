...
Paket ini adalah sumber ringkas yang dapat dilanjutkan untuk versi `0.31.3`.
...
biasa 84/84; total penguasaan berbasis solusi lengkap 108/108; dan D60-LAB01
lengkap 1/4.
...
- `source/id-ID/` memuat sumber semantik Bahasa Indonesia, termasuk ketiga
  ...
  D60-LAB01 sebagai materi asli edisi.
- `backend/` memuat 7.404 rekaman append-only dengan skema
...
D60-LAB01, petunjuk asli, dan paket terpadu berada di bawah CC BY-SA 4.0
