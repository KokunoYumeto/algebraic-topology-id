...
Paket ini adalah sumber ringkas yang dapat dilanjutkan untuk versi `0.31.5`.
...
- `source/id-ID/` memuat sumber semantik Bahasa Indonesia, termasuk ketiga
  ...
  D60-LAB01, D60-LAB02, dan D60-LAB03 sebagai materi asli edisi.
- `backend/` memuat 7.694 rekaman append-only dengan skema
...
```powershell
python -B scripts/qa-computation-lab-003.py
python -B scripts/validate-backend-append-only-computation-lab-003.py
...
D60-LAB01/02/03, petunjuk asli, dan paket terpadu berada di bawah CC BY-SA
