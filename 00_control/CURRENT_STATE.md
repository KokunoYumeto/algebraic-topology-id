...
- Next executable action: perform one narrow GitHub commit/push of this verified boundary, anonymously read back changed public bytes, then update the existing Zenodo concept/version and Figshare article/collection lineages (no duplicate records), preserving partial/finishing truth and exact licenses. After public receipts, resume contiguous translation at `Notes.tex:3948`.
