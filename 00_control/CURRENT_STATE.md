...
Status: active production. Source admission and composite route selection are closed. Units 001–021 translate Roberts `Notes.tex:134–4500` contiguously; every admitted unit has independent P1/P2/P3-zero review, stable IDs, solved mastery, append-only backend records, deterministic cumulative readers, and exact public GitHub readback. Unit 22 is already source-frozen and independently clean at `Notes.tex:4501–4938`; its backend and cumulative reader are the next admission work, and Unit 23 was not started. The existing public Zenodo lineage is current through Unit 20 (`10.5281/zenodo.22071667`, concept `10.5281/zenodo.22061489`), avoiding a one-unit DOI update. The same-field Indonesian terminology QA is complete, its Unit 20 propagation is closed, and the edition records `OpenAI Codex gpt-5.6-sol, Ultra` without diminishing source or human credit. After all 30 Roberts lectures, the selected Fomberg lines 31–4185 and exact original closure follow; see `CURRICULUM_ROUTE_AND_FOMBERG_HANDOFF.md`.
