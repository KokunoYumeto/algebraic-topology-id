...
Status: active production. Source admission and composite route selection are closed. Units 001–022 translate Roberts `Notes.tex:134–4938` contiguously; every admitted unit has independent P1/P2/P3-zero review, stable IDs, solved mastery, append-only backend records, and deterministic cumulative readers. Unit 22 is locally sealed and ready for the existing GitHub and Zenodo lineages; Unit 23 begins at line 4939 and has only a read-only source audit so far. The existing Zenodo lineage is public through Unit 20 (`10.5281/zenodo.22071667`, concept `10.5281/zenodo.22061489`), making Unit 22 a coherent two-lecture update. The same-field Indonesian terminology QA and its Unit 20 propagation are closed, and the edition records `OpenAI Codex gpt-5.6-sol, Ultra` without diminishing source or human credit. After all 30 Roberts lectures, the selected Fomberg lines 31–4185 and exact original closure follow; see `CURRICULUM_ROUTE_AND_FOMBERG_HANDOFF.md`.

## Current verified Units 001–022 local boundary (2026-08-23)
...
- Immediate action: one narrow Unit 22 content commit/push, successful Pages deployment, anonymous raw/reader readback, then reader-first publication to the existing Zenodo concept and anonymous byte/hash readback. Only after that seal may Unit 23 translation start from its already audited line 4939 boundary.
