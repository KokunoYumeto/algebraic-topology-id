...
- **Checkpoint kumulatif terverifikasi Unit 1–19 (sudah dipublikasikan):** [HTML semantik mandiri](https://kokunoyumeto.github.io/algebraic-topology-id/units-001-019/) — permukaan utama offline dengan MathML asli; [HTML sumber di repositori](output/html/units-001-019/index.html); [PDF A4 sekunder](output/pdf/topologi-aljabar-unit-001-019-id.pdf) — 221 halaman; [manifest](output/ARTIFACT_MANIFEST_UNITS_001_019.csv), [resi QA kumulatif](qa/UNITS_001_019_QA.json), dan [resi visual/browser](qa/UNITS_001_019_VISUAL_QA.md). Cakupan sumber `Notes.tex:134–3947` (Kuliah 1–19); terjemahan berstatus selesai pada batas ini, bukan keseluruhan 30 kuliah. [Zenodo 0.19.0](https://doi.org/10.5281/zenodo.22070794) mempertahankan delapan berkas dan pembacaan anonim byte/hash; [resi GitHub](00_control/GITHUB_PUBLICATION_RECEIPT_UNITS_001_019.json) dan [resi Zenodo](00_control/ZENODO_PUBLICATION_RECEIPT_UNITS_001_019.json).
...
- [Rilis preservasi Zenodo Unit 1–13](https://doi.org/10.5281/zenodo.22061490) tetap menjadi versi historis; konsep berkelanjutan `10.5281/zenodo.22061489` kini memiliki versi Unit 1–19 di atas.
- Figshare Unit 1–13 dicatat sebagai lineage historis (`10.6084/m9.figshare.33314982.v1`); bounded update Unit 1–19 belum dipublikasikan karena API mengembalikan `InactiveAccount`, tanpa membuat item duplikat. Lihat [resi status Figshare](00_control/FIGSHARE_PUBLICATION_RECEIPT_UNITS_001_019.json).
- [Pembaca HTML kumulatif Unit 1–10](https://kokunoyumeto.github.io/algebraic-topology-id/units-001-010/) dan [PDF Unit 1–10](output/pdf/topologi-aljabar-unit-001-010-id.pdf) tetap dipertahankan sebagai batas kesepuluh. Akun GitHub telah dipulihkan dan batas Unit 1–19 sudah dibaca kembali anonim dengan hash yang sama.
...
- Sumber semantik: [Unit 1](source/id-ID/reader-unit-001.md), [Unit 2](source/id-ID/units/unit-002-lecture-002.md), [Unit 3](source/id-ID/units/unit-003-lecture-003.md), [Unit 4](source/id-ID/units/unit-004-lecture-004.md), [Unit 5](source/id-ID/units/unit-005-lecture-005.md), [Unit 6](source/id-ID/units/unit-006-lecture-006.md), [Unit 7](source/id-ID/units/unit-007-lecture-007.md), [Unit 8](source/id-ID/units/unit-008-lecture-008.md), [Unit 9](source/id-ID/units/unit-009-lecture-009.md), [Unit 10](source/id-ID/units/unit-010-lecture-010.md), [Unit 11](source/id-ID/units/unit-011-lecture-011.md), [Unit 12](source/id-ID/units/unit-012-lecture-012.md), [Unit 13](source/id-ID/units/unit-013-lecture-013.md), [Unit 14](source/id-ID/units/unit-014-lecture-014.md), [Unit 15](source/id-ID/units/unit-015-lecture-015.md), [Unit 16](source/id-ID/units/unit-016-lecture-016.md), [Unit 17](source/id-ID/units/unit-017-lecture-017.md), [Unit 18](source/id-ID/units/unit-018-lecture-018.md), dan [Unit 19](source/id-ID/units/unit-019-lecture-019.md). Unit 1–13 sudah termasuk dalam pembaca/backend publik lama; Unit 1–19 kini memiliki batas kumulatif lokal yang telah diaudit dan siap dipush.

Unit 1–19 mencakup `Notes.tex` baris 134–3947: pengantar topologi aljabar, topologi awal dan akhir, perekatan, keterhubungan, homotopi, ruang penutup, pengangkatan, monodromi, grup dan grupoid fundamental, klasifikasi ruang penutup, grup homotopi lebih tinggi, bundel serat, dan barisan eksak panjang. Pembaca kumulatif memuat 710 ID stabil dan 7.451 simpul MathML. Pemeriksaan penguasaan edisi yang ditambahkan mempunyai hint dan solusi lengkap; dua pertanyaan sumber yang belum memiliki permukaan jawaban tetap ditandai sebagai pertanyaan sumber, bukan diklaim tertutup.

Setelah Unit 17, [QA terminologi Indonesia dalam bidang yang sama](qa/INDONESIAN_TERMINOLOGY_QA_2026-08-22.md) membandingkan edisi ini dengan artikel Indonesia tentang kategori ruang penutup. Sumber hidup Unit 1–19 kini memakai bentuk pilihan `fungtor`, `morfisma`, `lembaran`, dan `tertutup rata`; bentuk lama tetap dapat ditemukan sebagai varian backend. Berkas pembaca/rilis Unit 1–13 yang sudah diterbitkan tidak ditimpa, sehingga hash dan resi historisnya tetap benar; batas Unit 1–19 memakai migrasi yang sama dan menambahkan istilah Kuliah 19.
...
```powershell
python scripts/validate-backend-units-001-019.py
pwsh -NoProfile -File scripts/build-units-001-019.ps1
python scripts/qa-units-001-019.py
```
...
`scripts/validate-backend.py` tetap disimpan sebagai validator historis batas
Unit 1–13; batas aktif Unit 1–19 memakai validator yang disebut terakhir.
...
Produksi terjemahan, restrukturisasi semantik, QA, build, dan persiapan rilis edisi ini dilakukan dengan **OpenAI Codex gpt-5.6-sol, Ultra** atas arahan pengguna. Catatan proses ini tidak menggantikan kredit David Michael Roberts sebagai penulis sumber ataupun atribusi dan lisensi setiap komponen.
...
- [QA kumulatif Unit 1–10](qa/UNITS_001_010_QA.json)
- [QA visual Unit 1–10](qa/UNITS_001_010_VISUAL_QA.md)
...
- [Rereview independen Unit 18](qa/UNIT_018_INDEPENDENT_REVIEW.md)
- [Audit sumber Unit 18](qa/UNIT_018_SOURCE_AUDIT.md)
- [Rereview independen Unit 19](qa/UNIT_019_INDEPENDENT_REVIEW.md)
- [Audit sumber Unit 19](qa/UNIT_019_SOURCE_AUDIT.md)
- [QA Unit 19](qa/UNIT_019_QA.json)
- [QA kumulatif Unit 1–19](qa/UNITS_001_019_QA.json)
- [QA visual Unit 1–19](qa/UNITS_001_019_VISUAL_QA.md)
- [Resi backend Unit 1–19](qa/BACKEND_UNITS_001_019_RECEIPT.json)
- [Validator backend Unit 1–19](scripts/validate-backend-units-001-019.py)
- [QA terminologi Indonesia lintas-sumber](qa/INDONESIAN_TERMINOLOGY_QA_2026-08-22.md)

Pembaca lengkap masih dalam produksi. Kuliah Roberts 20–30 akan diterjemahkan secara berurutan; setelah itu materi homologi/metode seluler Fomberg yang telah dipilih dan lapisan penguasaan/lab/capstone yang tidak tersedia dalam inti akan ditulis tersendiri dan ditandai sebagai materi edisi.
