#!/usr/bin/env python3
"""Seal the exact local input ledger for the Fomberg Unit 006 release.
...
def load_packager():
    spec = importlib.util.spec_from_file_location("o012_fomberg_006_packager", PACKAGER_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError("could not load the Unit 006 release packager")
