#!/usr/bin/env python3
"""Publish the sealed Roberts 001-030 + Fomberg 001-005 checkpoint.

The transaction is locked to Zenodo concept DOI 10.5281/zenodo.22061489 and
public predecessor 22097007 (version 0.30.4).  It creates one new version,
...
SPEC = importlib.util.spec_from_file_location("o012_fomberg_004_publisher", BASE_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("could not load the proved Fomberg 001-004 publisher")
...
base.RELEASE = (
    base.LANE / "release" / "zenodo-roberts-001-030-fomberg-001-005"
)
...
base.SEED_RECORD = 22097007
base.CONCEPT_DOI = "10.5281/zenodo.22061489"
base.MODEL_NOTE = "OpenAI Codex gpt-5.6-sol, Ultra"
engine.PREVIOUS_RECORD_ID = 22097007
engine.PREVIOUS_DOI = "10.5281/zenodo.22097007"
base.RELEASE_ID = "o012-composite-id-roberts-001-030-fomberg-001-005-v0.30.5"
base.TITLE = (
...
base.FILE_NAMES = [
    base.PDF_NAME,
    "TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_005_READER.html",
    (
...
def verify_local() -> tuple[dict, dict]:
    ...
    if not (
        ...
        and fomberg.get("line_end") == 3122
        and fomberg.get("sections") == "1.1-1.11"
        ...
        and fomberg.get("next_source_line") == 3123
...
def make_receipt(
    ...
    return {
        ...
        "scope": (
            ...
            "Fomberg algebraic_topology.tex lines 31-3122, Sections 1.1-1.11, "
            "O012-FOM-001/002/003/004/005 complete; next line 3123; "
