#!/usr/bin/env python3
"""Publish the sealed Roberts 001-030 + Fomberg 001-004 checkpoint.

The transaction is locked to Zenodo concept DOI 10.5281/zenodo.22061489 and
public predecessor 22088708 (version 0.30.3).  It creates one new version,
...
SPEC = importlib.util.spec_from_file_location("o012_fomberg_003_publisher", BASE_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("could not load the proved Fomberg 001-003 publisher")
checkpoint = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(checkpoint)
engine = checkpoint.previous
base = checkpoint.base

base.RELEASE = (
    base.LANE / "release" / "zenodo-roberts-001-030-fomberg-001-004"
)
...
base.SEED_RECORD = 22088708
base.CONCEPT_DOI = "10.5281/zenodo.22061489"
base.MODEL_NOTE = "OpenAI Codex gpt-5.6-sol, Ultra"
engine.PREVIOUS_RECORD_ID = 22088708
engine.PREVIOUS_DOI = "10.5281/zenodo.22088708"
base.RELEASE_ID = "o012-composite-id-roberts-001-030-fomberg-001-004-v0.30.4"
base.TITLE = (
...
base.FILE_NAMES = [
    base.PDF_NAME,
    "TOPOLOGI_ALJABAR_ID_ROBERTS_001_030_FOMBERG_001_004_READER.html",
    (
...
def verify_local() -> tuple[dict, dict]:
    ...
    if not (
        ...
        and fomberg.get("line_end") == 2846
        and fomberg.get("sections") == "1.1-1.10"
        ...
        and fomberg.get("next_source_line") == 2847
...
def make_receipt(
    ...
    return {
        ...
        "scope": (
            ...
            "Fomberg algebraic_topology.tex lines 31-2846, Sections 1.1-1.10, "
            "O012-FOM-001/002/003/004 complete; next line 2847; "
