#!/usr/bin/env python3
"""Seal execution and independent-review closure for O012/D60 Lab 3."""
...
STATIC = ROOT / "qa/computation-lab-003/STATIC_QA.json"
CODE_REVIEW = ROOT / "qa/computation-lab-003/INDEPENDENT_CODE_REVIEW.json"
MATH_REVIEW = ROOT / "qa/computation-lab-003/INDEPENDENT_MATH_REVIEW.json"
LANGUAGE_REVIEW = ROOT / "qa/computation-lab-003/INDEPENDENT_SOURCE_LANGUAGE_REVIEW.json"
EXECUTION = ROOT / "qa/computation-lab-003/EXECUTION_RECEIPT.json"
COMBINED = ROOT / "qa/COMPUTATION_LAB_003_QA.json"
MODEL = "OpenAI Codex gpt-5.6-sol, Ultra"
ROUTES = ["D60-R12", "D60-R14"]


def require(condition: bool, message: str) -> None:
    if not condition:
        raise SystemExit(f"Lab 3 QA finalizer FAIL: {message}")
...
def main() -> int:
    ...
    require(static.get("laboratory_id") == "D60-LAB03", "static laboratory mismatch")
    ...
    for path, kind in kinds.items():
        ...
        require(receipt.get("laboratory_id") == "D60-LAB03", f"{kind} laboratory mismatch")
    ...
    combined = {
        ...
        "checks": {
            ...
            "route_scope_D60_R12_R14": "PASS",
            "terminology_0503_0514": "PASS",
    ...
    print(json.dumps({
        "status": "PASS", "laboratory_id": "D60-LAB03",
