#!/usr/bin/env python3
"""Verify the public Unit 24 GitHub/Pages release without trusting local files.
...
BASE_COMMIT = "869bb3bd190f9442ff6059d0142674e1d44b63b9"
CONTENT_COMMIT = "8d3484aa2a3f8f611d90d1efa45bb454bcd03676"
RELEASE_COMMIT = "8d3484aa2a3f8f611d90d1efa45bb454bcd03676"
RELEASE_TREE = "ac64588f4000ff40fa5cd334b258c96ad90cca17"
RUN_ID = 32682942914
JOB_ID = 97302647322
DEPLOYMENT_ID = 6055441517
DEPLOYMENT_STATUS_ID = 17210867247
PAGES_URL = "https://kokunoyumeto.github.io/algebraic-topology-id/units-001-024/"
PAGES_BYTES = 3_927_104
PAGES_SHA256 = "28a84406de9e196070965920a7f7937177197977f9ddf118f0f8b07d464cbf0f"
EXPECTED_CHANGED_FILES = 52
VERIFIED_AT = "2026-08-24T04:26:54+02:00"
OUTPUT = ROOT / "00_control/GITHUB_PUBLICATION_RECEIPT_UNITS_001_024.json"
...
def main() -> int:
    ...
    critical = {
        "source/id-ID/units/unit-024-lecture-024.md": (43_085, "993ad0c3493caff6bd15ab2bcf435f6cbb1f49ed9a1e11bc1009d649ae2d3647"),
        "output/html/units-001-024/index.html": (PAGES_BYTES, PAGES_SHA256),
        "output/pdf/topologi-aljabar-unit-001-024-id.pdf": (1_907_368, "5189b04f2f28d7e8192c16e8ef070e23bbf98085d150d1f2124d15c071ccf9b8"),
        "output/ARTIFACT_MANIFEST_UNITS_001_024.csv": (249, "23d2b33dd8eb08ba82bb020e3607abbf24925d79e774ca177be228656800a0ff"),
        "qa/UNITS_001_024_BUILD_RECEIPT.json": (7_560, "a050b3d282d43033ccdd7565bc6ee301eee6c30014ef6d8b84c5ec490406129a"),
        "qa/BACKEND_APPEND_ONLY_UNIT_024_CUMULATIVE_RECEIPT.json": (6_692, "4f77c57c62eba9b031873898cb073be9c9c3772b472088c4fd8c5ee8cc20648e"),
    }
    ...
    raw_url = (
        ...
        "output/html/units-001-024/index.html"
    )
    raw = fetch(raw_url, accept="text/html")
    pages = fetch(PAGES_URL + "?release=" + RELEASE_COMMIT, accept="text/html")
    expected_pages = release["output/html/units-001-024/index.html"]
    ...
    receipt = {
        "schema_version": "1.0",
        "receipt_id": "O012-GITHUB-PUBLICATION-UNITS-001-024",
        ...
        "pages": {
            ...
            "source_path": "output/html/units-001-024/index.html",
