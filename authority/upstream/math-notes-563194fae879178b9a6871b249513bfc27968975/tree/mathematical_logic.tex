...
% Redefine \models
\DeclareRobustCommand{\models}{%
  \mathrel{\vDash}%
}

% Define custom \nmodels
\DeclareRobustCommand{\nmodels}{%
  \mathrel{\text{\ooalign{$\vDash$\cr\hss\raisebox{0.2ex}{\scalebox{0.8}{$/$}}\hss}}}%
}
...
\begin{theorem}[De Bruijn–Erd\"os theorem]
...
\subsection{Predicate logic proof system}
